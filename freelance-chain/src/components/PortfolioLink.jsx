...
const PortfolioLinks = ({ links = {} }) => {
  const hasLinks = links.linkedin || links.github || links.personalPortfolio;
    ...
    <div className="space-y-2">
      {links.linkedin && (
        ...
        >
          ...
          <ExternalLink size={16} className="ml-auto text-purple-700" />
        </a>
      )}
      ...
      {links.personalPortfolio && (
        ...
        >
          ...
          <span className="text-gray-800">Personal Portfolio</span>
          <ExternalLink size={16} className="ml-auto text-purple-700" />
        </a>
      )}
    </div>
