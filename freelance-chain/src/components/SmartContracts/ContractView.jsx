...
const ContractView = () => {
    ...
    if (error) return <div className="p-4 bg-red-50 border-l-4 border-red-500 text-red-700 rounded my-4">
        Error: {error}
    </div>;
    
    if (!contract) return <div className="p-4 bg-yellow-50 border-l-4 border-yellow-500 text-yellow-700 rounded my-4">
        Contract not found
    </div>;
    return (
