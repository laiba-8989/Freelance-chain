    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="sm:flex sm:items-center sm:justify-between mb-6">
        <div className="mb-4 sm:mb-0">
          <h1 className="text-2xl font-bold text-[#0C3B2E]">Contracts</h1>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-[#0C3B2E]">
              <tr>
                {['Contract ID', 'Client', 'Freelancer', 'Amount', 'Status', 'Actions'].map((header) => (
                  <th
                    key={header}
                    scope="col"
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between">
          ...
          <div className="flex space-x-2">
            ...
            <button
              onClick={() => setPage(p => Math.min(data.pages, p + 1))}
              disabled={page === data.pages}
              className={`px-3 py-1 rounded-md border ${page === data.pages ? 'border-gray-200 text-gray-400' : 'border-[#0C3B2E] text-[#0C3B2E] hover:bg-[#0C3B2E] hover:text-white'} transition-colors`}
            >
              Next
            </button>
          </div>
