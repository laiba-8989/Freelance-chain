...
//         {/* Top Navbar */}
//         <div className="sticky top-0 z-50 flex items-center h-16 px-4 bg-white shadow-sm">
//           <button
...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-40 w-64 bg-white shadow-lg transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 flex flex-col`}>
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div className="flex items-center justify-center h-16 px-4 bg-green-600 shrink-0">
            <h1 className="text-xl font-bold text-white">Admin Panel</h1>
          </div>
      ...
      <div className="lg:pl-64 flex flex-col flex-1">
        {/* Top Navbar */}
        <div className="sticky top-0 z-30 flex items-center h-16 px-4 bg-white shadow-sm shrink-0">
          <button
            onClick={() => setSidebarOpen(!sidebarOpen)}
            className="p-2 text-gray-500 rounded-md lg:hidden hover:bg-gray-100"
          >
        ...
        {/* Content area */}
        <div className="flex-grow overflow-y-auto pt-16 h-[calc(100vh-64px)]">
          <main className="p-6">
            <Outlet />
          </main>
        </div>
