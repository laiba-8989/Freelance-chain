...
//         // Ensure we have all necessary user data and handle different response structures
...
//       const response = await api.get(`/conversations/between/${currentUserId}/${user._id}`);
...
//         const newConvResponse = await api.post('/conversations', {
//           members: [currentUserId, user._id]
//         });
